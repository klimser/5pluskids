...
/**
 * This is the model class for table "{{%module_subject_age}}".
 *
 * @property integer $id
 ...
 */
class SubjectAge extends ActiveRecord
{
    use UploadImage;
