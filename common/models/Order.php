...
class Order extends ActiveRecord
{
    ...
    public function notifyAdmin() {
        ...
        return Yii::$app->mailQueue->add('На сайте 5pluskids.uz новая заявка!', Yii::$app->params['noticeEmail'], 'order-html', 'order-text', ['userName' => $this->name, 'subjectName' => $this->subject]);
    }
